...
ids=find(assignments(:,1)==assignments(:,2));%find where the classes assignment are equal

assignments_to_update=IndexToAssignment(ids, factor.card);


factor=SetValueOfAssignment(factor,assignments_to_update,similarity);
