...
for i=1:length(factors)
   ...
   for idassign=1:length(assignments)
       factors(i)=SetValueOfAssignment(factors(i),assignments(idassign,:),pairwiseModel(assignments(idassign,1),assignments(idassign,2)));
