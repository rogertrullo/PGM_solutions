...
sampleFactorList_1 = constructGeneticNetwork(pedigree, alleleFreqs, alphaList);
...
sampleFactorListDecoupled_1 = constructDecoupledGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
...
phenotypeFactorSigmoid_1 = constructSigmoidPhenotypeFactor(alleleWeights, geneCopyVarParentOneList, geneCopyVarParentTwoList, phenotypeVar);