...
phenotypeFactor.card=[2,n_genotypes];%2 phenotype (have or not have) n_genotypes 
phenotypeFactor.var=[phenotypeVar,genotypeVar];
...
for i=1:2:prod(phenotypeFactor.card)
    ...
    phenotypeFactor= SetValueOfAssignment(phenotypeFactor, assignments(i:i+1,:), [alphaList(idx_alpha),1-alphaList(idx_alpha)]);
