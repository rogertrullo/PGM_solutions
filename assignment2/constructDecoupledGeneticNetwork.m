...
parents_matrix=pedigree.parents;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
idfactor=1;
for idpeople=1:numPeople
    %First genotype
    if isequal(parents_matrix(idpeople,:),[0,0])%is a parent       
        geneCopyFactor_1 = childCopyGivenFreqsFactor(alleleFreqs, idpeople);
        geneCopyFactor_2 = childCopyGivenFreqsFactor(alleleFreqs, numPeople+idpeople);
    else
        geneCopyFactor_1 = childCopyGivenParentalsFactor(numAlleles, idpeople, parents_matrix(idpeople,1), numPeople+parents_matrix(idpeople,1));
        geneCopyFactor_2 = childCopyGivenParentalsFactor(numAlleles, numPeople+idpeople, parents_matrix(idpeople,2), numPeople+parents_matrix(idpeople,2));
        
    end
    %second phenotype
    phenotypeFactor = phenotypeGivenCopiesFactor(alphaList, numAlleles, idpeople, numPeople+idpeople, 2*numPeople+idpeople);

    factorList(idfactor)=geneCopyFactor_1;
    factorList(idfactor+1)=geneCopyFactor_2;
    factorList(idfactor+2)=phenotypeFactor;
    idfactor=idfactor+3;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  